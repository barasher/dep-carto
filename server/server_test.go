...
func (m *modelMock) Add(s model.Server) error {
	m.add.inServer = s
	return m.add.outErr
}
...
func (m *modelMock) GetAll() ([]model.Server, error) {
...
func (m *modelMock) GetSince(d time.Duration) ([]model.Server, error) {
